 使用idea启动tomcat eidtCOnfiguration 选择tomcat7,点击右侧绿色向右三角运行
Running war on http://localhost:9090/，我在pom.xml插件中指定了端口号9090
jdbc在spring中的获取方式问题
 Connections could not be acquired from the underlying database!

 1bootstrap做页面
 2使用jquery的2个插件，coutdown,cookie
 3对于js的模块化方式，把url放在一个地方统一管理 获取 对象封装 属性等
